...
;12f675-PwmFet.mpas,165 :: 		end else begin
	GOTO       L__main37
L__main36:
;12f675-PwmFet.mpas,166 :: 		while adc_vol<vTarget do begin
L__main39:
	MOVF       _vTarget+1, 0
	SUBWF      _adc_vol+1, 0
	BTFSS      STATUS+0, 2
...
L__main95:
	BTFSC      STATUS+0, 0
	GOTO       L__main40
;12f675-PwmFet.mpas,167 :: 		if VOL_PWM<PWM_MAX then
	MOVLW      255
	SUBWF      _VOL_PWM+0, 0
	BTFSC      STATUS+0, 0
	GOTO       L__main44
;12f675-PwmFet.mpas,168 :: 		Inc(VOL_PWM)
	INCF       _VOL_PWM+0, 1
	GOTO       L__main45
;12f675-PwmFet.mpas,169 :: 		else
L__main44:
;12f675-PwmFet.mpas,170 :: 		break;
	GOTO       L__main40
L__main45:
;12f675-PwmFet.mpas,171 :: 		adc_vol:=ADC_Read(1);
	MOVLW      1
	MOVWF      FARG_ADC_Read_channel+0
	CALL       _ADC_Read+0
	MOVF       R0+0, 0
...
;12f675-PwmFet.mpas,172 :: 		end;
	GOTO       L__main39
L__main40:
;12f675-PwmFet.mpas,173 :: 		while adc_vol>vTarget do begin
L__main47:
	MOVF       _adc_vol+1, 0
	SUBWF      _vTarget+1, 0
	BTFSS      STATUS+0, 2
...
L__main96:
	BTFSC      STATUS+0, 0
	GOTO       L__main48
;12f675-PwmFet.mpas,174 :: 		if VOL_PWM>PWM_LOW then
	MOVF       _VOL_PWM+0, 0
	SUBLW      0
	BTFSC      STATUS+0, 0
	GOTO       L__main52
;12f675-PwmFet.mpas,175 :: 		Dec(VOL_PWM)
	DECF       _VOL_PWM+0, 1
	GOTO       L__main53
;12f675-PwmFet.mpas,176 :: 		else
L__main52:
;12f675-PwmFet.mpas,177 :: 		break;
	GOTO       L__main48
L__main53:
...
;12f675-PwmFet.mpas,179 :: 		end;
	GOTO       L__main47
L__main48:
;12f675-PwmFet.mpas,180 :: 		if (VCharge=0) then begin
	BTFSC      GP4_bit+0, BitPos(GP4_bit+0)
	GOTO       L__main55
;12f675-PwmFet.mpas,181 :: 		adc_vol:=ADC_Read(1);
	MOVLW      1
	MOVWF      FARG_ADC_Read_channel+0
	CALL       _ADC_Read+0
	MOVF       R0+0, 0
	...
	MOVF       R0+1, 0
	MOVWF      _adc_vol+1
;12f675-PwmFet.mpas,182 :: 		if adc_vol>=vTarget then
	MOVF       _vTarget+1, 0
	SUBWF      R0+1, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main97
...
L__main55:
;12f675-PwmFet.mpas,185 :: 		short_check:=Delay1ms(short_Timer,short_count);
...
;12f675-PwmFet.mpas,186 :: 		if short_check then
	MOVF       R0+0, 0
	BTFSC      STATUS+0, 2
	GOTO       L__main61
;12f675-PwmFet.mpas,187 :: 		short_count:=0;
	CLRF       _short_count+0
L__main61:
;12f675-PwmFet.mpas,188 :: 		LED1_tm:=240;
	MOVLW      240
	MOVWF      _LED1_tm+0
;12f675-PwmFet.mpas,189 :: 		end;
L__main37:
;12f675-PwmFet.mpas,190 :: 		end else
	GOTO       L__main34
L__main33:
;12f675-PwmFet.mpas,191 :: 		if out_short then begin
	MOVF       _out_short+0, 0
	BTFSC      STATUS+0, 2
	GOTO       L__main64
;12f675-PwmFet.mpas,192 :: 		if Delay1ms(out_timer,100) then begin
	MOVLW      _out_timer+0
	MOVWF      FARG_Delay1ms_t+0
	MOVLW      100
	MOVWF      FARG_Delay1ms_limit+0
	...
	BTFSC      STATUS+0, 2
	GOTO       L__main67
;12f675-PwmFet.mpas,193 :: 		Dec(out_488);
	DECF       _out_488+0, 1
;12f675-PwmFet.mpas,194 :: 		if out_488=0 then begin
	MOVF       _out_488+0, 0
	XORLW      0
	BTFSS      STATUS+0, 2
	GOTO       L__main70
;12f675-PwmFet.mpas,195 :: 		out_short:=False;
	CLRF       _out_short+0
;12f675-PwmFet.mpas,196 :: 		short_Timer:=TICK_1000;
	MOVF       _TICK_1000+0, 0
	MOVWF      _short_Timer+0
;12f675-PwmFet.mpas,197 :: 		short_count:=cShort_Recover;
	MOVLW      10
	MOVWF      _short_count+0
;12f675-PwmFet.mpas,198 :: 		short_check:=False;
	CLRF       _short_check+0
...
L__main64:
L__main34:
;12f675-PwmFet.mpas,204 :: 		if (VOL_PWM=PWM_MAX) or (VOL_PWM=0) then begin
	MOVF       _VOL_PWM+0, 0
	XORLW      255
	MOVLW      255
	BTFSS      STATUS+0, 2
	...
	BTFSC      STATUS+0, 2
	GOTO       L__main73
;12f675-PwmFet.mpas,205 :: 		if (VCharge=0) and (VOL_PWM=0) then begin
	BTFSC      GP4_bit+0, BitPos(GP4_bit+0)
	GOTO       L__main98
	BSF        84, 0
	GOTO       L__main99
...
L__main99:
	...
	BTFSC      STATUS+0, 2
	GOTO       L__main76
;12f675-PwmFet.mpas,206 :: 		LED_TMCount:=1;
	MOVLW      1
	MOVWF      _LED_TMCount+0
;12f675-PwmFet.mpas,207 :: 		LED1_tm:=240;
	MOVLW      240
	MOVWF      _LED1_tm+0
;12f675-PwmFet.mpas,208 :: 		end else
	GOTO       L__main77
L__main76:
;12f675-PwmFet.mpas,209 :: 		LED1_tm:=128;
	MOVLW      128
	MOVWF      _LED1_tm+0
L__main77:
;12f675-PwmFet.mpas,210 :: 		end;
L__main73:
;12f675-PwmFet.mpas,212 :: 		if not LED1_Toggle then begin
	COMF       _LED1_Toggle+0, 0
	MOVWF      R0+0
	BTFSC      STATUS+0, 2
	GOTO       L__main79
;12f675-PwmFet.mpas,213 :: 		LED1_Toggle:=True;
	MOVLW      255
	MOVWF      _LED1_Toggle+0
;12f675-PwmFet.mpas,214 :: 		LED1_Timer:=TICK_1000;
	MOVF       _TICK_1000+0, 0
	MOVWF      _LED1_Timer+0
;12f675-PwmFet.mpas,215 :: 		end;
L__main79:
;12f675-PwmFet.mpas,216 :: 		if LED1_Toggle and Delay1ms(LED1_Timer,LED1_tm) then begin
	MOVLW      _LED1_Timer+0
	MOVWF      FARG_Delay1ms_t+0
	MOVF       _LED1_tm+0, 0
	MOVWF      FARG_Delay1ms_limit+0
	...
	BTFSC      STATUS+0, 2
	GOTO       L__main82
;12f675-PwmFet.mpas,217 :: 		if LED_TMCount>0 then
	MOVF       _LED_TMCount+0, 0
	SUBLW      0
	BTFSC      STATUS+0, 0
	GOTO       L__main85
;12f675-PwmFet.mpas,218 :: 		Dec(LED_TMCount);
	DECF       _LED_TMCount+0, 1
L__main85:
;12f675-PwmFet.mpas,219 :: 		if LED_TMCount=0 then begin
	MOVF       _LED_TMCount+0, 0
	XORLW      0
	BTFSS      STATUS+0, 2
	GOTO       L__main88
;12f675-PwmFet.mpas,220 :: 		LED1:=not LED1;
	MOVLW
	XORWF      GP2_bit+0, 1
